...
export function HeroStage(props?: HeroStageProps) {
  ...
  return (
    <div className="hero-stage-shell glass-panel">
      <div className="hero-stage-shell__inner">
        <div className="stage-layout stage-layout--hero hero-stage-layout">
          <div className="stage-copy hero-copy">
            <h1 className="stage-title hero-title">Stressed Out Advertising</h1>
            <p className="hero-subheader">Creative Stress Testing Ad Engine</p>
